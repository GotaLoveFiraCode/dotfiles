return {
	...
	config = function()
		...
		-- lsp.bzl.setup(coq.lsp_ensure_capabilities())
		...
		lsp.perlnavigator.setup(coq.lsp_ensure_capabilities())
		lsp.pkgbuild_language_server.setup(coq.lsp_ensure_capabilities())
		lsp.remark_ls.setup(coq.lsp_ensure_capabilities())
		lsp.rubocop.setup(coq.lsp_ensure_capabilities())
		lsp.solargraph.setup(coq.lsp_ensure_capabilities())
		lsp.taplo.setup(coq.lsp_ensure_capabilities())
		lsp.unocss.setup(coq.lsp_ensure_capabilities())
